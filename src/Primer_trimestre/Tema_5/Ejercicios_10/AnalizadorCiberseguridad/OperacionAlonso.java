...
public class OperacionAlonso {
    public static void main(String[] args) {
        ...
        for (Map<String, Object> evento: eventosUnicos) {
            // Metemos la informacion en variables (mejora presentacion)
        ...
        for (Map<String, Integer>tiposVfallos:mapaFallos.values()){
            for (String tipo: tiposVfallos.keySet()){
                if (frecuenciaTipos.containsKey(tipo)){
                    frecuenciaTipos.put(tipo, frecuenciaTipos.get(tipo)+ tiposVfallos.get(tipo));
                }else
                    frecuenciaTipos.put(tipo, tiposVfallos.get(tipo));
            }
        }
