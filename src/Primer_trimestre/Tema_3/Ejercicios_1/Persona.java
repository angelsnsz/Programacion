...
- calcularIMC(): calculara si la persona está en su peso ideal (peso en kg/(altura^2 en m)), si esta fórmula devuelve un valor menor que 20, el metodo devuelve un -1, si devuelve un número entre 20 y 25 (incluidos), está en un peso normal, por tanto, devuelve un 0 y si devuelve un valor mayor que 25 significa que tiene sobrepeso, devuelve un 1. Te recomiendo que uses constantes para devolver estos valores.
...
- generaDNI(): genera un número aleatorio de 8 cifras y con ese número, calcula su letra correspondiente. Este metodo será invocado cuando se construya el objeto. No será visible al exterior.
