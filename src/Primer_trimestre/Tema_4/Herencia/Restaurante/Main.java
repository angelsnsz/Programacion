...
public class Main {
    public static void main(String[] args) {
        ...
        platosComanda1[1] = new PlatoCarne("Chuletón", 25.99, "Al punto");

        Plato[] platosComanda2 = new Plato[5];
        platosComanda2[0] = new PrimerPlato("Macarrones", 9.99, true);
        platosComanda2[1] = new PlatoCarne("Solomillo", 15.99, "Carbonizado");
        platosComanda2[2] = new PlatoPescado("Merluza", 10.95);
        platosComanda2[3] = new PlatoPostre("Tarta de chocolate", 4.99, true);
        platosComanda2[4] = new PlatoPostre("Tarta de queso", 4.99, false);
